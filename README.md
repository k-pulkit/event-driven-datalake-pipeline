...
*   **Credential Generation & Storage:** Database credentials are autogenerated by Terraform and stored in **AWS Secrets Manager**, preventing credentials from being hardcoded or leaking in CloudWatch logs or job arguments. Automatic rotation is not yet wired up — a natural next step would be a Secrets Manager rotation Lambda for the RDS master password.
